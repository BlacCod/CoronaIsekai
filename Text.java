...
public class Text {
	...
	+ "1) 2 Silbermünzen: Der Glasarbeiter fühlt sich beleidigt. Wie kannst du ihm so wenig für seine Arbeit zahlen? Zuerst weigert er sich, den Auftrag anzunehmen, aber schließlich einigen Sie sich auf 10 Silbermünzen. (-10 Reputation points.)"
	+ "2) 10 Silbermünzen: Das ist ein gutes Angebot, der Glasarbeiter bietet Ihnen fröhlich seine Hilfe an! Dank dieser Tatsache sprechen die anderen Verkäufer gut von dir. +10 Reputation points."
	+ "3) 1 Goldmünze. Der Glasarbeiter ist schockiert und fragt sich, warum jemand bereit ist, so viel für eine Glasarbeit zu bezahlen. Er nimmt das Geld dankbar an, aber er denkt dass du ein bisschen naiv bist. (+5 Reputation points.)");
	antwort = 0;
		do {
		antwort = Main.scanner.nextInt();
		if (antwort==3) {
